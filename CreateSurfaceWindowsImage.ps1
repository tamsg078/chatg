...
.EXAMPLE
    .\CreateSurfaceWindowsImage.ps1 -ISO <ISO path> -OSSKU ProWorkstations -DestinationFolder "C:\Temp" -Device SurfacePro7
...
Param(
    ...
    [Parameter(
        Position=2,
        Mandatory=$False,
        HelpMessage="What SKU should be used inside ISO (valid parameters are 'ProWorkstations' or 'Enterprise'), default is ProWorkstations - note checking is disabled currently as language support is added"
        )]
        [ValidateSet('ProWorkstations', 'Enterprise')]
        [string]$OSSKU = 'ProWorkstations',
...
Function Update-Win10WIM
{
    ...
    $ProWorkstationsUnattendXMLPath = "$WorkingDirPath\Win10ProWorkstations_Unattend.xml"
    ...
    {
        ProWorkstations {"Windows 10 Pro for Workstations"}
